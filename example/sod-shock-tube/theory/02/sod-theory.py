...
def Sod_Theory():
    ...
    output.write("title=\"THE FLOW FIELD OF ONEFLOW\"\n")
    output.write("variables=\"x\" \"rho\" \"u\" \"mach\" \"p\" \n")
    
    nxp = 21;
    nNodes = nxp + 8;
    
    output.write( "zone  i = {0}\n".format(nNodes) );
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xl, r4, u4, rmach4, p4) )
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xhead, r4, u4, rmach4, p4) )
    ...
    for n in range(1, nxp+1):
        ...
        output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xx, rx, ux, mx, px) )
        
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xtail, r3, u3, rmach3, p3) )
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xc   , r3, u3, rmach3, p3) )
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xc   , r2, u2, rmach2, p2) )
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xs   , r2, u2, rmach2, p2) )
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xs   , r1, u1, rmach1, p1) )
    output.write( "{0}  {1}  {2}  {3}  {4}\n".format(xr   , r1, u1, rmach1, p1) )
    output.close()
