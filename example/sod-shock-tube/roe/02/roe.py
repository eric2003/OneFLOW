...
class MyPlot:
    ...
    def PlotCompare( self, x, q ):
        ...
        plt.figure("Exact solution for the Sod's shock-tube problem", figsize=(10, 8), dpi=100)
        plt.subplot(2, 2, 1)
        plt.plot(self.x, self.r, color='k', linewidth=1.0, label="theory")
        #plt.plot(x, rr, marker='o', markersize=1, color='b', linewidth=1.0, label="OneFLOW-CFD")
        plt.scatter(x, rr,  color= "blue", marker= "o", s=1, label="OneFLOW-CFD" )
        ...
        plt.subplot(2, 2, 2)
        plt.plot(self.x, self.u, color='k', linewidth=1.0, label="theory")
        #plt.plot(x, uu, marker='o', markersize=1, color='b', linewidth=1.0, label="OneFLOW-CFD")
        plt.scatter(x, uu,  color= "blue", marker= "o", s=1, label="OneFLOW-CFD" )
        plt.xlabel("$x$")
        plt.ylabel(r"$u$")
        plt.legend()
        
        plt.subplot(2, 2, 3)
        plt.plot(self.x, self.e, color='k', linewidth=1.0, label="theory")
        #plt.plot(x, ee, marker='o', markersize=1, color='b', linewidth=1.0, label="OneFLOW-CFD")
        plt.scatter(x, ee,  color= "blue", marker= "o", s=1, label="OneFLOW-CFD" )
        plt.xlabel("$x$")
        plt.ylabel(r"$E$")
        plt.legend()
        
        plt.subplot(2, 2, 4)
        plt.plot(self.x, self.p, color='k', linewidth=1.0, label="theory")
        #plt.plot(x, pp, marker='o', markersize=1, color='b', linewidth=1.0, label="OneFLOW-CFD")
        plt.scatter(x, pp,  color= "blue", marker= "o", s=1, label="OneFLOW-CFD" )
        plt.xlabel("$x$")
        plt.ylabel(r"$p$")
        plt.legend()
...
#-----------------------------------------------------------------------------#
def wenoLTest(nx,u,f):
    #for i in range(0, nx):
    #    print("i=",i," wenoLTest u=",u[i,0])    
    ...
    for m in range(0, 3):
        ...
        print('i+1,m=',i+1,m,v1,v2,v3,v4,v5,f[i+1,m],f[i+1,0])
    ...
    for i in range(0, nx+1):
        print("i=",i," wenoLTest f 1111 =",f[i,0])          
...
def rhs( nx, dx, gamma, q, r ):
    ...
    #for i in range(0, nx+1):
        #print("i=",i," f=",f[i,0]," fL=",fL[i,0]," fR=",fR[i,0], " qL=",qL[i,0]," qR=",qR[i,0])
