    ...
    )
{
    ...
    Create( c1, c1new );
    Create( y1, y1new );
    std::vector<double> xx1( y1new.size() );
    thomas_algorithm( a1new, b1new, c1new, y1new, xx1 );
    Print( xx1, "xx1" );
    ...
    Create( c2, c2new );
    Create( y2, y2new );
    std::vector<double> xx2( y2new.size() );
    thomas_algorithm( a2new, b2new, c2new, y2new, xx2 );
    Print( xx2, "xx2" );
