...
icount = 0
for i in range(0, nx+1):
    print("{0:.15f}".format(u_error[i]), end = " ")
    #print(u_error[i], " ")
    icount += 1
    if( icount % 5 == 0 ):
        print("")
...
icount = 0
for i in range(0, nx+1):
    print("{0:.15f}".format(u_e[i]), end = " ")
    icount += 1
    if( icount % 5 == 0 ):
        print("")     

my_max_error = compute_max_error( nx, u_error )
