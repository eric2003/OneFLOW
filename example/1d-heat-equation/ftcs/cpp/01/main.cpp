...
public:
    void solve()
    {
        std::cout << "solve()\n";
        Grid grid;
        //ReadCgnsGrid( "../heat1d.cgns", &grid );
        ReadCgnsGrid( "../heat1dni81.cgns", &grid );
        int ni = grid.x.size();
        std::cout << "ni = " << ni << "\n";
        ...
        for ( int i = 0; i < ni; ++ i )
        {
            std::cout << std::setprecision(15) << un[ i ] << " ";
            icount ++;
            if ( icount % 5 == 0 )
            {
                std::cout << "\n";
        ...
        for ( int i = 0; i < ni; ++ i )
        {
            ...
            std::cout << std::setprecision(15) << u_error[ i ] << " ";
            icount ++;
            if ( icount % 5 == 0 )
            {
                std::cout << "\n";
        ...
        for ( int i = 0; i < ni; ++ i )
        {
            std::cout << std::setprecision(15) << u_e[ i ] << " ";
            icount ++;
            if ( icount % 5 == 0 )
            {
                std::cout << "\n";
