...
public:
    ...
    void ToGlobal( std::vector<int> & oriPoint );
    void ToLocal( std::vector<int> & oriPoint );
...
public:
    ...
    void GetLeafInterfaceBc( std::vector< InterfaceSplitBc * > & leafInterfaceBcList );
public:
...
public:
    ...
    void FindDonorInterface( InterfaceSplitBc * interfaceSplitBc, InterfaceInfo & interfaceInfo );
