...
public:
    void CreateInterfaceBcFromParentBc( SplitBc * parentSplitBc );
    void CreateInterfaceBcFromParentBcNewVersion( SplitBc * parentSplitBc );
    void GetLeafBcs( std::vector< SplitBc * > & leafBcs );
};
...
public:
    ...
    void CreateSplitBcFromOverlapRegion( SplitBc * parentSplitBc, RangeRegion & overlapRegion );
    void CreateChildInterfaceBc( SplitBc * targetInterfaceBc );
    bool CreateChildInterfaceBc( SplitBc * candidateInterfaceBc, SplitBc * targetInterfaceBc );

    void CreateChildInterfaceBc( RangeRegion & targeRegionBox, SplitZone * sourceZone );
    bool CreateChildInterfaceBc( SplitBc * parentSplitBc, RangeRegion & targeRegionBox, SplitZone * sourceZone );
    void CreateSplitBc( SplitBc * parentSplitBc );
    void AddSplitBc( SplitBc * splitBc );
    void GetZoneGlobalBox( RangeRegion & zoneBox );
    void GetZoneLocalBox( RangeRegion & globalBox, RangeRegion & localBox );
    SplitZone * GetRootZone();
    void GetLeafBcList( std::vector< SplitBc * > & leafBcList );
public:
...
public:
    ...
    void DumpMultiBasePartitionedGridFile();
