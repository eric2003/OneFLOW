...
class Mgdata:
    ...
    def VCycle( self, level ):
        ...
        self.CalSubVh(level)
        #r2h->v4h
        self.CalSubVh(level+1)
        #r4h->v8h
        self.CalSubVh(level+2)
        #r8h->v16h
        self.CalSubVh(level+3)
        
        #from v16h to v8h
        self.CalCoarse2Fine( level+3 )
        #from v8h to v4h
        self.CalCoarse2Fine( level+2 )
        #from v4h to v2h
        self.CalCoarse2Fine( level+1 )
        #from v2h to vh
        self.CalCoarse2Fine( level )
