# src/numerics/residual.py
from numerics.flux.factory import FluxCalculatorFactory
from numerics.reconstructor.factory import ReconstructorFactory
...
class ResidualCalculator:
    ...
    def __init__(self, cfd):
        ...
        self.reconstructor = ReconstructorFactory.create(cfd)
