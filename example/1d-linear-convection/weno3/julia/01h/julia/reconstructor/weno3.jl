...
function reconstruct(rec::Weno3Reconstructor, q::Vector{Float64}, cfd::Any)
    ...
    _reconstruct_left_interfaces(domain, q, solution.q_face_left)
    _reconstruct_right_interfaces(domain, q, solution.q_face_right)
end

function _reconstruct_left_interfaces(domain, u, qL)
...
function _reconstruct_right_interfaces(domain, u, qR)
