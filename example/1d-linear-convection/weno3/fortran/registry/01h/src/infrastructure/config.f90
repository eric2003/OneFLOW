...
module config_module
    ...
    private
    public :: real64, cfd_config, config_print, config_with_reconstruction
    ...
    type :: cfd_config
        ...
        integer :: rk_order = 1
        real(real64) :: wave_speed = 1.0_real64
        real(real64) :: final_time = 0.625_real64
        real(real64) :: dt = 0.025_real64
        character(len=20) :: boundary_type = "periodic"
        real(real64) :: left_boundary_value = 1.0_real64
        real(real64) :: right_boundary_value = 2.0_real64
    ...
    subroutine config_with_reconstruction(this, scheme, order)
        ...
        if (present(order)) then
            ...
            if (index(this%recon_scheme, 'weno') > 0) then
                ...
                print *, "[ERROR] Unsupported reconstruction scheme: ", trim(this%recon_scheme)
                return
            end if
        end if
