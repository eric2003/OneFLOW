...
module recon_module
	...
	use weno5_module, only: Weno5ReconstructorType  ! 新增WENO5
    ...
    type, public :: ReconType
		...
		type(Weno5ReconstructorType), allocatable :: weno5_recon  ! 新增WENO5
    contains
    ...
    subroutine recon_reconstruct(this, q, config, domain, solution)
        ...
        if (trimmed_scheme == "eno") then
			...
			if ( order == 3 ) then
				...
				call this%weno5_recon%reconstruct(q, domain, solution)
			endif
        else
