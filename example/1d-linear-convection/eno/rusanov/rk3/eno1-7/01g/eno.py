...
def plot_eno_field(xcc, u_list, u_analytical):
    # 定义一个包含不同颜色、线形和标记的列表
    styles = [
...
def main():
    ...
    for iorder in range(1, iorder_max+1):
        u = RunEno(mesh, iorder)
        u_list.append(u)
        
    plot_eno_field(mesh.xcc, u_list, u_analytical)
