...
for file in solution_files:
    ...
    plt.plot(x, u, marker=style['marker'], markerfacecolor='none', linestyle=style['linestyle'], color=style['color'],  markersize=5, linewidth=1, alpha=1.0, label=f'Numerical (Rusanov)')
    icount += 1
