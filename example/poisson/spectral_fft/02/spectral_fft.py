...
#plt.figure("OneFLOW-CFD Solver+2D Poisson Equation+Spectral method", figsize=(5, 4), dpi=100)
...
plt.figure("OneFLOW-CFD Solver+2D Poisson Equation+Spectral method", figsize=(10, 4), dpi=100)
