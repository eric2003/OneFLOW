...
# ========== 示例 1：完全匹配用户期望的格式 ==========
print("=" * 70)
print("示例 1：完全匹配 (size=6, N=7, mid_count=2)")
print("=" * 70)
...
# ========== 示例 2：参数换成 α，N换成M，1行中间 ==========
print("=" * 70)
print("示例 2：参数 α，末尾 M (size=8, mid_count=1)")
print("=" * 70)
...
# ========== 示例 4：和原图一致（无中间行） ==========
print("=" * 70)
print("示例 4：和原图一致 (size=6, mid_count=0)")
print("=" * 70)
