...
template <typename VectorX, typename VectorY>
bool plot_bacic(const VectorX &x, const VectorY &y, const std::string &s,
          const std::map<std::string, std::string> &keywords) {
...
bool plot(const VectorX& x, const VectorY& y) {
    return plot_bacic(x, y, "", std::map<std::string, std::string>{});
}

template <typename VectorX, typename VectorY>
bool plot(const VectorX& x, const VectorY& y, const std::string& s) {
    return plot_bacic(x, y, s, std::map<std::string, std::string>{});
}
...
bool plot(const VectorX &x, const VectorY &y,
          const std::map<std::string, std::string> &keywords) {
    return plot_bacic(x, y, "", keywords);
}
