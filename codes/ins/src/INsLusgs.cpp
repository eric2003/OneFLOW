...
void INsLusgs::CompFaceEigenValue( RealField & prim )
{
    //这里输入的应该是作用单元界面上的值
...
{
    this->CompFaceEigenValue( inslu.primF );
    ...
    ONEFLOW::CompIDH( inslu.primj, inslu.gama, inslu.dqj, dh, hm );
