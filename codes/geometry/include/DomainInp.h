...
public:
    ...
    void Analysys();
    void CompDomainPatch( int nZone, MultiDomain & md );
    void CompDomainPatch( int iZone, int jZone, MultiDomain & md );
...
public:
    ...
    void CompFacePoint( StrGrid * grid, PointSearch * pointSearch, IjkBox * ijkBox, int zId, PBlkSet * pblkSet );
    void CompDomainPatch( int nZone, GridMediator * gridMediator );
    void CompDomainPatch( int iZone, int jZone, GridMediator * gridMediator );
